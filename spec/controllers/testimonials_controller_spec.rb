...
describe TestimonialsController do
  ...
  #      post :create, {:testimonial => { "name" => "invalid value" }}, valid_session
  #      assigns(:testimonial).should be_a_new(Testimonial)
  #    end
  #
  ...
  #      Testimonial.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
  #      put :update, {:id => testimonial.to_param, :testimonial => { "name" => "MyString" }}, valid_session
  #    end
  #
  #    it "assigns the requested testimonial as @testimonial" do
  #      testimonial = Testimonial.create! valid_attributes
  ...
  #      # Trigger the behavior that occurs when invalid params are submitted
  #      Testimonial.any_instance.stub(:save).and_return(false)
  #      put :update, {:id => testimonial.to_param, :testimonial => { "name" => "invalid value" }}, valid_session
  #      assigns(:testimonial).should eq(testimonial)
  #    end
  #
